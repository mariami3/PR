...
namespace Ds3 {
    ...
    public partial class BookDataSet : global::System.Data.DataSet {
        ...
        public partial class BooKsDataTable : global::System.Data.TypedTableBase<BooKsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BooKsRow AddBooKsRow(string BooksName, string DateCriation, string AuthorName) {
...
namespace Ds3.BookDataSetTableAdapters {
    ...
    public partial class AuthorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Authors] ([AuthorName]) VALUES (@AuthorName);\r\nSELECT ID_Autho" +
                "rs, AuthorName FROM Authors WHERE (ID_Authors = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Authors] SET [AuthorName] = @AuthorName WHERE (([ID_Authors] = @Ori" +
                "ginal_ID_Authors) AND ([AuthorName] = @Original_AuthorName));\r\nSELECT ID_Authors" +
                ", AuthorName FROM Authors WHERE (ID_Authors = @ID_Authors)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ds3.Properties.Settings.Default.BookConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_Authors, AuthorName FROM dbo.Authors";
        ...
        public virtual int Delete(int Original_ID_Authors, string Original_AuthorName) {
        ...
        public virtual int Update(string AuthorName, int Original_ID_Authors, string Original_AuthorName, int ID_Authors) {
            if ((AuthorName == null)) {
                throw new global::System.ArgumentNullException("AuthorName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_ID_Authors));
            if ((Original_AuthorName == null)) {
                throw new global::System.ArgumentNullException("Original_AuthorName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(ID_Authors));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string AuthorName, int Original_ID_Authors, string Original_AuthorName) {
            return this.Update(AuthorName, Original_ID_Authors, Original_AuthorName, Original_ID_Authors);
        }
    }
    ...
    public partial class BooKsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT b.ID_BooKs, b.BooksName, a.AuthorName, b.DateCriation\r\nFROM BooKs b\r\nINNER" +
                " JOIN Authors a ON b.Authors_ID = a.ID_Authors;";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT b.ID_BooKs, b.BooksName, a.AuthorName, b.DateCriation\r\nFROM BooKs b\r\nINNER" +
                " JOIN Authors a ON b.Authors_ID = a.ID_Authors;";
        ...
        public virtual BookDataSet.BooKsDataTable GDB() {
